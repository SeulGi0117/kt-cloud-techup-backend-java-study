...
public class QueryDslConfiguration {
	// 의존성 주입하는 autowired랑 비슷한 기능
	@PersistenceContext
	private EntityManager entityManager; // qeuryDsl, test코드 요 2가지에서만 쓰게됨
	...
	// 2. {domain}query => 클래스를 만들어서 사용. // 스프링 특성을 이용해서 간편하게 쓰는 방법

	// 이 안에 엔티티 매니저 넣어서 쿼리를 빈으로 등록가능
