...
public class Problem07_RSPWinCounter {
    ...
    public static RSP changeChar(char c){
        switch (c){
            case 'R': return RSP.ROCK;
            case 'S': return RSP.SCISSORS;
            case 'P': return RSP.PAPER;
            default: throw new IllegalArgumentException("허용되지 않는 문자. R, S, P 중 하나 입력.");
        }
    }
    ...
    public static RSP computerChoice() {
        ...
        switch (r){
            case 0: return RSP.ROCK;
            case 1: return RSP.SCISSORS;
            case 2: return RSP.PAPER;
